...
- **CSS** (Semanas 2-4): sintaxe, seletores (id, classe, tag), estilos interno/externo, fontes, cores, margens, bordas, **flexbox**, **grid**, position/shadow e **media queries** para layouts responsivos.
- **Bootstrap** (Semana 5): grid, tipografia, imagens, tabelas, figuras, cards e barra de navegação.
- **React** (Semanas 7-8): componentes (App, Header, Footer, Home), composição, navegação com React Router e estilização com CSS.
- **JavaScript** (Semanas 9-12): variáveis, tipos, operadores, funções, manipulação do DOM, destructuring, hooks (useState, useEffect, custom hooks), LocalStorage e validação de formulários.
- **Requisições assíncronas** (Semanas 13-14).
- **Projeto final** (Semanas 14-15): desenvolvimento do projeto da disciplina.
